...
const Navbar = () => {
  ...
  return (
   ...
   >
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className=' hidden md:flex items-center gap-2'>
          <button onClick={() => handleNavClick('contact')}
            className='px-7 py-2.5 bg-linear-to-b from-primary via-primary/50 to-primary/20 hover:bg-white/40 text-black transition-all duration-300 font-extrabold text-base rounded-[17px] border border-white/40 '>
              Hire Me
          </button>
        </div>
    ...
    <div className={` md:hidden transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-120 opacity-100' : 'max-h-0 opacity-0'}`}>
      <div className='bg-black/95 backdrop-blur-lg border-t border-white/10 px-5 py-6 space-y-3'>
        ...
        className=' w-full px-7 py-2.5 bg-linear-to-b  from-primary via-primary/50 to-primary/20 hover:bg-white/40 text-black transition-all duration-300 font-extrabold text-base rounded-[17px] border border-white/40 '
        >
          Hire Me
        </button>
      </div>
