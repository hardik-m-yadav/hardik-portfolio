...
import { Mail, MapPin, GitBranch, Send, MessageSquare, Icon, Share2, X } from 'lucide-react'
...
const Contact = () => {
    ...
    const phoneNumber = "917410194730"; // 👉 your WhatsApp number with country code (India = 91)
...
${formData.message}
  ...
  return (
    <section id='contact' className=' relative py-20 bg-black overflow-x-hidden'>
        <div className=' absolute inset-0 overflow-hidden'>
            <div className=' absolute top-1/4 left-1/4 w-40 h-40 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-primary/20 opacity-30 rounded-full blur-3xl'/>
             <div className=' absolute bottom-1/4 right-1/4 w-40 h-40 sm:w-64 sm:h-64 lg:w-96 lg:h-96  bg-primary/20 opacity-30 rounded-full blur-3xl'/>
              <div className=' absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 sm:w-64 sm:h-64 lg:w-96 lg:h-96  bg-primary/10 opacity-30 rounded-full blur-3xl'/>
        </div>
        ...
        <div className=' relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className=' grid md:grid-cols-2 gap-12 '>
                <FadeIn delay={100}>
                    <div className=' min-w-0 bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8'>
                    ...
                    <div className=' space-y-8 min-w-0'>
                        <div>
                            ...
                            <p className=' text-white/60 leading-relaxed'>
                                I'm always open to discussing new projects, creative ideas, or new opportunities to be part of your vision. Feel free to reach out!
                            </p>
                        </div>
                            ...
                            <div className=' group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                <div className=' flex items-start gap-4 min-w-0'>
                                    ...
                                    <div className=' flex-1'>
                                        ...
                                        className=' text-white hover:text-[#A8FF8D] transition-colors text-xs sm:text-lg md:text-lg lg:text-lg font-medium  '
                                        >
                                            {PERSONAL_INFO.email}
                                        </a>
                                    </div>
                               ...
                               <div className=' group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                <div className=' flex items-start gap-4 min-w-0'>
                                    <div className=' p-3 bg-linear-to-br from-primary/20 to-primary/20 border border-primary/30 rounded-xl'>
                                      <a href="https://maps.app.goo.gl/zQwfE5HXuJCgSgJF8"
                                         target='_blank'
