...
import { Download, Code2, Sparkles, Icon } from 'lucide-react';
            ...
            <div className=' flex flex-col gap-12'>
                 <div className=' flex flex-col gap-8'>
                    ...
                    <FadeIn delay={100}>
                        <h2 className=' text-4xl lg:text-5xl font-normal text-white leading-tight'>
                            Developing Digital Products That Matters
                        </h2>
                    </FadeIn>
                 ...
                 <FadeIn delay={400}>
                    <button onClick={() => window.open(PERSONAL_INFO.resume, '_blank')}
                        className='inline-flex items-center gap-3  bg-linear-to-b from-primary via-primary/50 to-primary/20 hover:bg-white/90 text-black rounded-full px-8 py-4 text-base font-medium transition-all duration-300 w-fit group'
                        >
                ...
                <div className=' grid grid-cols-2 gap-4'>
                            ...
                            <div className=' flex items-start gap-4'>
                                ...
                                <div className=' flex-1'>
                                    ...
                                    <p className=' text-sm text-white/70 leading-relaxed'>
                                        Specialized in building scalable web applications with modern technologies and best practises.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className=' relative group'>
                        ...
                        <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                            ...
                            <p className=' text-sm text-white/70 leading-relaxed'>
                                Writing maintainable, and scable code using modern React practices.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className=' relative group'>
                        ...
                        <div className=' relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                            ...
                            <p className=' text-sm text-white/70 leading-relaxed'>
                                Optimizing applications for fast load time and smooth user experience.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className=' relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                            <div className=' grid grid-cols-3 gap-6 text-center'>
                                <div>
                                    ...
                                    <div className=' text-xs text-white/60 '>Dedicated</div>
                                </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className='text-xs text-white/60'>Fast Learner</div>
                            </div>
                        </div>
                    </div>
                    </div>
