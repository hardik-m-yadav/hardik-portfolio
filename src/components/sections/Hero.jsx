...
import { ChevronDown, Star, Download, Folder } from "lucide-react";
          ...
          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-2.5 px-[18px] py-[11px] mb-8 bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full">
                ...
                <span className=" text-xs md:text-sm text-white tracking-[1.2px]">
                  {PERSONAL_INFO.tittle} | Based in {PERSONAL_INFO.location}
                </span>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={200}>
              <p className=" text-lg text-white/70 max-w-[550px] mb-8">
                I'm a frontend developer skilled in React, JavaScript and modern UI frameworks. I focus on building responsive, user-friendly web applications and continuously improving through real-world projects.
                Built 10+ projects including Netflix clone, Admin Dashboard & API-based apps.
              </p>
            </FadeIn>
              ...
              <button onClick={() => scrollToSection('contact')}
                ...
                <FadeIn delay={400}>
                    <button onClick={() => window.open(PERSONAL_INFO.resume, '_blank')}
                        className='inline-flex items-center gap-3 mb-8  bg-linear-to-b mx-2 from-primary via-primary/50 to-primary/20 hover:bg-white/90 text-black rounded-full px-8 py-4 text-base font-medium transition-all duration-300 w-fit group'
                        >
                            <Download className=' w-5 h-5 group-hover:translate-y-0.5 transition-transform duration-300'/>
                            Download Resume
                    </button>
                     <button onClick={() => scrollToSection('projects')}
                        className='inline-flex  items-center gap-3 mb-8 bg-linear-to-b mx-2 z-10 bg-white text-[#212121] hover:bg-white/90 text-black rounded-full px-8 py-4 text-base font-medium transition-all duration-300 w-fit group'
                        >
                            <Folder className=' w-5 h-5 group-hover:translate-y-0.5 transition-transform duration-300'/>
                            View Projects
                    </button>
                 </FadeIn>
